...
excerpt: "Introducing my new personal website built with Jekyll and GitHub Pages, optimized for LLM discoverability."
---
...
1. **Simple and Free**: GitHub Pages offers free hosting with custom domain support
2. **Markdown-Based**: I can write content in Markdown and focus on writing, not formatting
3. **Version Controlled**: Every change is tracked in Git
4. **Portable**: It's just static files - I can move to any host anytime
5. **Fast**: No database, no server-side processing - just fast, secure HTML
...
- **Schema.org structured data**: JSON-LD markup for better content understanding
...
Stay tuned! You can subscribe via [RSS](/feed.xml) or connect with me on [GitHub](https://github.com/dheerajn).
